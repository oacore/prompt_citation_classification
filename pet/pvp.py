...
class CitationFunctionPVP(PVP):
    ...
    def get_parts(self, example: InputExample) -> FilledPattern:
        ...
        if self.pattern_id == 0:
            return [text], ["#CITATION_TAG is", self.mask, "."]
            
        elif self.pattern_id == 1:
            return [text], ["Function of #CITATION_TAG is", self.mask, "."]
            
        elif self.pattern_id == 2:
            return [text], ["Why does citing paper cite #CITATION_TAG?", self.mask, "."]
    ...
    def verbalize(self, label) -> List[str]:
        return CitationFunctionPVP.VERBALIZER[label]


PVPS = {
    "function": CitationFunctionPVP,
